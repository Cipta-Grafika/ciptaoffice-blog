...
@section('content')
    <div class="cms-page">
        ...
        <section class="cms-surface" aria-label="Daftar kategori produk">
            <div class="cms-list-toolbar"><p class="cms-surface-kicker mb-0">Taksonomi produk</p><p class="cms-record-count mb-0">{{ $categories->total() }} kategori</p></div>
            <x-cms-table :paginator="$categories" :column-count="5" :empty="$categories->isEmpty()" empty-icon="tags"
                empty-title="Belum ada kategori" empty-description="Buat kategori untuk mulai menyusun katalog.">
                <x-slot:head>
                    <th>Kategori</th>
                    <th>Produk</th>
                    <th>Status</th>
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td><div class="cms-table-actions"><a class="btn btn-sm btn-outline-primary" href="{{ route('cms.categories.edit', $category) }}"><i class="bi bi-pencil-square" aria-hidden="true"></i>Edit</a></div></td>
                    </tr>
                @endforeach
            </x-cms-table>
        </section>
